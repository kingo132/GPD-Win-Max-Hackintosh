...
## 20210411
1. Added driver 360controller's System Preferences puglin of builtin-joystick, you may need to enable "Pretend to be an Xbox 360 Contoller" option in order to get controller to work in some games. Just copy the plugin builtin-joystick/Pref360Control.prefPane to /Library/PreferencePanes and you are all set. Note, I only tested this plugin under Catalina. I don't know if it will work under BigSur.
