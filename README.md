...
* Thunderbolt 3 is not driven - need to modify SSDT and BIOS configuration, may be the device path is TDM0? or RP09? RP01? RP05?
  * Testing 20201025: The [Belkin Thunderbolt™ 3 Express Dock HD](https://www.belkin.com/us/p/P-F4U095/) works perfectly when pluged before powerup the system. However, it does not support hot plug. I'm wondering if the thunderbolt is already drived. Although the thunderbolt information in system report is: Thunderbolt: No drivers are loaded. I also tested a External GPU Dock (Aorus Gaming Box + Asrock 5500XT Mini). The LED light in EGPU glows successfully. However, the startup process hang on gIOScreenLockstate. I got the EGPU path on Ubuntu. It is 05:00:0. I tried to add the EDID of Built-in and External Display. No luck, still hang.
